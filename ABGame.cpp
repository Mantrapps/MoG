...
//AlphaBeta
computing AlphaBetaGame(int depth,mboard board, bool type, int alpha, int beta)
{
    //need change
    computing comput;
    ...
    if (type) //white move - maximize(true)
    {
        ...
        for(int i=0;i<List.size();i++)
        {
            ...
            tempcomput=AlphaBetaGame(depth-1, List.at(i), false, alpha, beta);
    ...
    else
    {
        ...
        for(int i=0;i<List.size();i++)
        {
            ...
            tempcomput=AlphaBetaGame(depth-1, List.at(i), true, alpha, beta);
...
int main(int argc, const char * argv[]) {
    ...
    computing layout=AlphaBetaGame(depth, board,true,-99999, +99999);
